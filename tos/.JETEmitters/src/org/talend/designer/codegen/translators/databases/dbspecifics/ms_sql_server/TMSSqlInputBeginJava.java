...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_187 = NL + "\t\t\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_188 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();" + NL + "\t\t\t" + NL + "\t\t\tjava.util.List<String> talendToDBList_";
  protected final String TEXT_189 = " = new java.util.ArrayList();" + NL + "\t\t\tString[] talendToDBArray_";
  protected final String TEXT_190 = "  = new String[]{\"FLOAT\",\"NUMERIC\",\"NUMERIC IDENTITY\",\"DECIMAL\",\"DECIMAL IDENTITY\",\"REAL\"}; " + NL + "\t\t\tjava.util.Collections.addAll(talendToDBList_";
  protected final String TEXT_191 = ", talendToDBArray_";
  protected final String TEXT_192 = "); ";
  protected final String TEXT_193 = NL + "\t\t\tString dbschema_";
  protected final String TEXT_194 = " = (String)globalMap.get(\"";
  protected final String TEXT_195 = "\");";
  protected final String TEXT_196 = NL + "\t\t    String port_";
  protected final String TEXT_197 = " = ";
  protected final String TEXT_198 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_199 = " = ";
  protected final String TEXT_200 = " ;";
  protected final String TEXT_201 = NL + "\t\t\tString url_";
  protected final String TEXT_202 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_203 = " ;";
  protected final String TEXT_204 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_205 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_206 = " ;";
  protected final String TEXT_207 = NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_208 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_209 = " += \":\" + ";
  protected final String TEXT_210 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_211 = ")) {";
  protected final String TEXT_212 = NL + "\t\t\t\turl_";
  protected final String TEXT_213 = " += \"//\" + ";
  protected final String TEXT_214 = "; ";
  protected final String TEXT_215 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_216 = " += \";databaseName=\" + ";
  protected final String TEXT_217 = "; ";
  protected final String TEXT_218 = NL + "\t\t    }" + NL + "\t\t    url_";
  protected final String TEXT_219 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_220 = ";" + NL + "\t\t    String dbschema_";
  protected final String TEXT_221 = " = ";
  protected final String TEXT_222 = ";";
  protected final String TEXT_223 = NL + "\t\t\t";
  protected final String TEXT_224 = ".";
  protected final String TEXT_225 = " = mssqlGTU_";
  protected final String TEXT_226 = ".getDate(rsmd_";
  protected final String TEXT_227 = ", rs_";
  protected final String TEXT_228 = ", ";
  protected final String TEXT_229 = "column_index_";
  protected final String TEXT_230 = ");" + NL + "\t\t\t";
  protected final String TEXT_231 = NL + "\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_232 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_233 = ".getClob(";
  protected final String TEXT_234 = ");" + NL + "\t\t\t\tif(clob_";
  protected final String TEXT_235 = "!=null){" + NL + "\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_236 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_237 = ");" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_238 = " = tNTextImpl_";
  protected final String TEXT_239 = ".getValue();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttmpContent_";
  protected final String TEXT_240 = " = null;\t\t\t\t" + NL + "\t\t\t\t}";
  protected final String TEXT_241 = NL + "           \t\ttmpContent_";
  protected final String TEXT_242 = " = rs_";
  protected final String TEXT_243 = ".getString(";
  protected final String TEXT_244 = "column_index_";
  protected final String TEXT_245 = ");";
  protected final String TEXT_246 = NL + "            if(tmpContent_";
  protected final String TEXT_247 = " != null) {" + NL + "            \tif (talendToDBList_";
  protected final String TEXT_248 = " .contains(rsmd_";
  protected final String TEXT_249 = ".getColumnTypeName(";
  protected final String TEXT_250 = "column_index_";
  protected final String TEXT_251 = ").toUpperCase(java.util.Locale.ENGLISH))) {" + NL + "            \t\t";
  protected final String TEXT_252 = ".";
  protected final String TEXT_253 = " = FormatterUtils.formatUnwithE(tmpContent_";
  protected final String TEXT_254 = ");" + NL + "            \t} else {" + NL + "                \t";
  protected final String TEXT_255 = ".";
  protected final String TEXT_256 = " = tmpContent_";
  protected final String TEXT_257 = ";" + NL + "                }" + NL + "            } else {";
  protected final String TEXT_258 = NL + "                ";
  protected final String TEXT_259 = ".";
  protected final String TEXT_260 = " = null;" + NL + "            }";
  protected final String TEXT_261 = NL + "    " + NL + "\t";
  protected final String TEXT_262 = NL + "\t\t    int nb_line_";
  protected final String TEXT_263 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_264 = " = null;";
  protected final String TEXT_265 = NL + "\t\t        conn_";
  protected final String TEXT_266 = " = (java.sql.Connection)globalMap.get(\"";
  ...
  protected final String TEXT_298 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_299 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  ...
  protected final String TEXT_327 = ".getColumnName(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_397 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_398 = ".getObject(";
  protected final String TEXT_399 = "column_index_";
  protected final String TEXT_400 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_401 = NL + "                                    ";
  protected final String TEXT_402 = ".";
  protected final String TEXT_403 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_412 = ".setEPSG(";
  protected final String TEXT_413 = ");" + NL + "                                        }";
  protected final String TEXT_414 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_415 = NL + "                                  ";
  protected final String TEXT_416 = ".";
  protected final String TEXT_417 = "=dcg_";
  protected final String TEXT_418 = ";";
  protected final String TEXT_419 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_420 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_421 = " = ";
  protected final String TEXT_422 = "; i_";
  protected final String TEXT_423 = "  <= rsmd_";
  protected final String TEXT_424 = ".getColumnCount(); i_";
  protected final String TEXT_425 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_426 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_427 = ".getColumnTypeName(i_";
  protected final String TEXT_428 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_429 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_430 = ".getClob(i_";
  protected final String TEXT_431 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_432 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_433 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_434 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_435 = ".add(tNTextImpl_";
  protected final String TEXT_436 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_437 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_438 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_439 = ".getColumnTypeName(i_";
  protected final String TEXT_440 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_441 = ".add(rs_";
  protected final String TEXT_442 = ".getString(i_";
  protected final String TEXT_443 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_444 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_445 = ".";
  protected final String TEXT_446 = ", rs_";
  protected final String TEXT_447 = ", fixedColumnCount_";
  protected final String TEXT_448 = ",list_";
  protected final String TEXT_449 = ",";
  protected final String TEXT_450 = ");";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_452 = ".";
  protected final String TEXT_453 = ", rs_";
  protected final String TEXT_454 = ", fixedColumnCount_";
  protected final String TEXT_455 = ",";
  protected final String TEXT_456 = ");";
  protected final String TEXT_457 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_458 = ".";
  protected final String TEXT_459 = ", rs_";
  protected final String TEXT_460 = ", fixedColumnCount_";
  protected final String TEXT_461 = ",";
  protected final String TEXT_462 = ");";
  protected final String TEXT_463 = NL + "                                  Object geom = rs_";
  protected final String TEXT_464 = ".getObject(";
  protected final String TEXT_465 = "column_index_";
  protected final String TEXT_466 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_467 = ".";
  protected final String TEXT_468 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_469 = ".";
  protected final String TEXT_470 = " = null;" + NL + "                                  }";
  protected final String TEXT_471 = NL + "\t\t                          ";
  protected final String TEXT_472 = NL + "\t\t                    }";
  protected final String TEXT_473 = NL + "\t\t\t\t\t";
  protected final String TEXT_474 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_475 = " - Retrieving the record \" + nb_line_";
