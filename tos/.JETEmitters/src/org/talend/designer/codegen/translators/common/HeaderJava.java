...
public class HeaderJava
{
  ...
  protected final String TEXT_30 = NL + NL + "protected static void logIgnoredError(String message, Throwable cause) {";
  protected final String TEXT_31 = NL + "       log.error(message, cause);";
  protected final String TEXT_32 = NL + "       System.err.println(message);" + NL + "       if (cause != null) {" + NL + "               cause.printStackTrace();" + NL + "       }";
  protected final String TEXT_33 = NL + NL + "}";
  protected final String TEXT_34 = NL + "\tprivate ESBEndpointRegistry registry = null;" + NL + "" + NL + "\tpublic void setEndpointRegistry(ESBEndpointRegistry registry) {" + NL + "\t\tthis.registry = registry;" + NL + "\t}" + NL + "" + NL + "\tprivate ESBProviderCallback callback = null;" + NL + "" + NL + "\tpublic void setProviderCallback(ESBProviderCallback callback) {" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\t\tthis.callback = callback;" + NL + "\t\t";
  protected final String TEXT_36 = NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_37 = NL + "\t\tpublic ESBEndpointInfo getEndpoint() { return null; }" + NL + "\t";
