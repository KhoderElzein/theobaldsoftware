...
public class TMSSqlOutputEndJava {
  ...
  protected final String TEXT_46 = NL + "\t\tif ( isShareIdentity_";
  protected final String TEXT_47 = " ) {" + NL + "\t\t\tString setIdentityInsertONSQL_";
  protected final String TEXT_48 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_49 = " +\"] ON\";" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "        \tstmt_";
  protected final String TEXT_51 = ".execute(setIdentityInsertONSQL_";
  protected final String TEXT_52 = ");" + NL + "\t\t\t";
  protected final String TEXT_53 = NL + "        }";
  protected final String TEXT_54 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_55 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_56 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_57 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_58 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_59 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_60 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_61 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_62 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  ...
  protected final String TEXT_71 = NL + "        if(pstmtInsert_";
  protected final String TEXT_72 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_73 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_74 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_75 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_76 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  ...
  protected final String TEXT_84 = ",java.sql.Types.CHAR);" + NL + "\t\t";
  ...
  protected final String TEXT_89 = ",java.sql.Types.DATE);" + NL + "\t\t";
  ...
  protected final String TEXT_94 = ",java.sql.Types.ARRAY);" + NL + "\t\t";
  ...
  protected final String TEXT_99 = ",java.sql.Types.INTEGER);" + NL + "\t\t";
  ...
  protected final String TEXT_104 = ",java.sql.Types.VARCHAR);" + NL + "\t\t";
  ...
  protected final String TEXT_109 = ",java.sql.Types.OTHER);" + NL + "\t\t";
  ...
  protected final String TEXT_114 = ",java.sql.Types.BOOLEAN);" + NL + "\t\t";
  protected final String TEXT_115 = NL + "\t\t        if(bufferL";
  protected final String TEXT_116 = ".";
  protected final String TEXT_117 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_118 = ".setNull(count";
  protected final String TEXT_119 = ",java.sql.Types.DOUBLE);" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\t        if(bufferL";
  protected final String TEXT_121 = ".";
  protected final String TEXT_122 = "==null){" + NL + "\t\t            ";
  protected final String TEXT_123 = ".setNull(count";
  protected final String TEXT_124 = ",java.sql.Types.FLOAT);" + NL + "\t\t";
  protected final String TEXT_125 = NL + NL + "\t\t        }else{" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\t\t";
  protected final String TEXT_127 = NL + "\t\t        if(bufferL";
  protected final String TEXT_128 = ".";
  protected final String TEXT_129 = "==null){" + NL + "\t\t";
  protected final String TEXT_130 = NL + "\t\t        if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = ").toLowerCase())){" + NL + "\t\t";
  protected final String TEXT_133 = NL + "\t\t    ";
  protected final String TEXT_134 = ".setNull(count";
  protected final String TEXT_135 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t    } else if(bufferL";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = " == '\\0') {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_138 = ".setString(count";
  protected final String TEXT_139 = ",\"\");" + NL + "" + NL + "\t\t    } else {" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_140 = ".setString(count";
  protected final String TEXT_141 = ",String.valueOf(bufferL";
  protected final String TEXT_142 = ".";
  protected final String TEXT_143 = "));" + NL + "\t\t    }" + NL + "\t\t";
  protected final String TEXT_144 = NL + "\t\t        if(bufferL";
  protected final String TEXT_145 = ".";
  protected final String TEXT_146 = "!=null){" + NL + "\t\t            // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t            date_";
  protected final String TEXT_147 = " = bufferL";
  protected final String TEXT_148 = ".";
  protected final String TEXT_149 = ".getTime();" + NL + "\t\t            if (date_";
  protected final String TEXT_150 = " < year1_";
  protected final String TEXT_151 = " || date_";
  protected final String TEXT_152 = " >= year10000_";
  protected final String TEXT_153 = ") {" + NL + "\t\t                ";
  protected final String TEXT_154 = ".setString(count";
  protected final String TEXT_155 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t            } else {" + NL + "\t\t\t\t";
  protected final String TEXT_156 = NL + "                    \t";
  protected final String TEXT_157 = ".setString(count";
  protected final String TEXT_158 = ",TalendDate.formatDate(";
  protected final String TEXT_159 = ", ";
  protected final String TEXT_160 = ".";
  protected final String TEXT_161 = "));" + NL + "\t\t\t\t";
  protected final String TEXT_162 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_163 = ".setString(count";
  protected final String TEXT_164 = ",TalendDate.formatDatetimeoffset(";
  ...
  protected final String TEXT_173 = ".setTimestamp(count";
  protected final String TEXT_174 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_175 = "),calendar_datetimeoffset_";
  protected final String TEXT_176 = ");" + NL + "\t\t         ";
  protected final String TEXT_177 = NL + "\t\t         \t\t";
  protected final String TEXT_178 = ".setTimestamp(count";
  protected final String TEXT_179 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_180 = "));" + NL + "\t\t         ";
  protected final String TEXT_181 = NL + "\t\t\t\t";
  protected final String TEXT_182 = NL + "\t\t            }" + NL + "\t\t        }else{" + NL + "\t\t            ";
  protected final String TEXT_183 = ".setNull(count";
  protected final String TEXT_184 = ",java.sql.Types.DATE);" + NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_185 = NL + "\t\t        ";
  protected final String TEXT_186 = ".set";
  protected final String TEXT_187 = "(count";
  protected final String TEXT_188 = ",bufferL";
  protected final String TEXT_189 = ".";
  protected final String TEXT_190 = ");" + NL + "\t\t        ";
  protected final String TEXT_191 = NL + "\t\t        }" + NL + "\t\t";
  protected final String TEXT_192 = NL + "\t\tif(rowCount";
  protected final String TEXT_193 = "!=0){" + NL + "" + NL + "\t\tStringBuilder singleQueryInsertValueStmt = new StringBuilder();" + NL + "\t\tfor(int i=0 ; i < rowCount";
  protected final String TEXT_194 = " ; i++){" + NL + "\t\t     singleQueryInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_195 = "+\")\");" + NL + "\t\t     if (i != rowCount";
  protected final String TEXT_196 = " - 1)" + NL + "\t\t    \t singleQueryInsertValueStmt.append(\",\");" + NL + "\t\t}" + NL + "" + NL + "\t\tinsert_";
  protected final String TEXT_197 = " = \"INSERT INTO \"+";
  protected final String TEXT_198 = "+\" (\"+insertColName";
  protected final String TEXT_199 = "+\") VALUES \"+singleQueryInsertValueStmt.toString();" + NL + "" + NL + "\t\tpstmt_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".prepareStatement(insert_";
  protected final String TEXT_202 = ");" + NL + "\t\tint row2Count";
  protected final String TEXT_203 = " = 0;" + NL + "\t\t";
  protected final String TEXT_204 = NL + "\t\t\tint count";
  protected final String TEXT_205 = " = 1;" + NL + "\t\t";
  protected final String TEXT_206 = NL + "\t\tint count";
  protected final String TEXT_207 = " = 0;" + NL + "\t\t";
  protected final String TEXT_208 = NL + NL + "\t\tfor(BufferLine_";
  protected final String TEXT_209 = " bufferL";
  protected final String TEXT_210 = " : sInsertColValueList";
  protected final String TEXT_211 = "){" + NL + "\t\t";
  protected final String TEXT_212 = NL + "\t\t    \tcount";
  protected final String TEXT_213 = " = row2Count";
  protected final String TEXT_214 = "*";
  protected final String TEXT_215 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_216 = NL + "\t\t    \tcount";
  protected final String TEXT_217 = " = row2Count";
  protected final String TEXT_218 = "*";
  protected final String TEXT_219 = "+1;" + NL + "\t\t\t";
  protected final String TEXT_220 = NL + "\t\t            count";
  protected final String TEXT_221 = "++;" + NL + "\t\t            ";
  protected final String TEXT_222 = NL + "\t\t\t\tint count_dyn_";
  protected final String TEXT_223 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_224 = ".";
  protected final String TEXT_225 = ", pstmt_";
  protected final String TEXT_226 = ", count";
  protected final String TEXT_227 = "-1, \"";
  protected final String TEXT_228 = "\");" + NL + "\t\t\t\tcount";
  protected final String TEXT_229 = "+=count_dyn_";
  protected final String TEXT_230 = ";" + NL + "\t\t\t";
  protected final String TEXT_231 = NL + NL + "\t\t    row2Count";
  protected final String TEXT_232 = "++;" + NL + "\t\t}" + NL + "\t\tinsertedCount_";
  protected final String TEXT_233 = " = insertedCount_";
  protected final String TEXT_234 = " + pstmt_";
  protected final String TEXT_235 = ".executeUpdate();" + NL + "\t\t}";
  protected final String TEXT_236 = NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_237 = " = 0;" + NL + "\t\t\t\t\t\tif (pstmt_";
  protected final String TEXT_238 = " != null && batchSizeCounter_";
  protected final String TEXT_239 = " > 0) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_240 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_241 = ": pstmt_";
  protected final String TEXT_242 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_243 = " == -2 || countEach_";
  protected final String TEXT_244 = " == -3) {" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_245 = " += countEach_";
  protected final String TEXT_246 = ";" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_247 = NL + "\t\t\t\t\t\t}" + NL + "            \t    \t";
  protected final String TEXT_248 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_249 = " += countSum_";
  protected final String TEXT_250 = ";" + NL + "            \t    \t";
  protected final String TEXT_251 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_252 = " += countSum_";
  protected final String TEXT_253 = ";" + NL + "            \t    \t";
  protected final String TEXT_254 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_255 = " += countSum_";
  protected final String TEXT_256 = ";" + NL + "            \t    \t";
  protected final String TEXT_257 = NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_258 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_259 = NL + "                \tint countSum_";
  protected final String TEXT_260 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_261 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_262 = " += (countEach_";
  protected final String TEXT_263 = " < 0 ? 0 : countEach_";
  protected final String TEXT_264 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_265 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_266 = " += countSum_";
  protected final String TEXT_267 = ";" + NL + "            \t    \t";
  protected final String TEXT_268 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_269 = " += countSum_";
  protected final String TEXT_270 = ";" + NL + "            \t    \t";
  protected final String TEXT_271 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_272 = " += countSum_";
  protected final String TEXT_273 = ";" + NL + "            \t    \t";
  protected final String TEXT_274 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_275 = NL + "            \t}";
  protected final String TEXT_276 = NL + "        if(pstmt_";
  protected final String TEXT_277 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_278 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_279 = ".close();" + NL + "\t\t\t\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_280 = "\");" + NL + "\t\t\t";
  protected final String TEXT_281 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_282 = ");" + NL + "\t\t\t";
  protected final String TEXT_283 = NL + "        }";
  protected final String TEXT_284 = NL + "    String setIdentityInsertOFFSQL_";
  protected final String TEXT_285 = " = \"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_286 = " +\"] OFF\";";
  protected final String TEXT_287 = NL + "    stmt_";
  protected final String TEXT_288 = ".execute(setIdentityInsertOFFSQL_";
  protected final String TEXT_289 = ");";
  protected final String TEXT_290 = NL + "    stmt_";
  protected final String TEXT_291 = ".close();";
  protected final String TEXT_292 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_293 = "\", true);";
  protected final String TEXT_294 = NL + "            conn_";
  protected final String TEXT_295 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_296 = NL + "        conn_";
  protected final String TEXT_297 = " .close();";
  protected final String TEXT_298 = NL + "        resourceMap.put(\"finish_";
  protected final String TEXT_299 = "\", true);";
  protected final String TEXT_300 = NL;
  protected final String TEXT_301 = NL + "\tnb_line_deleted_";
  protected final String TEXT_302 = "=nb_line_deleted_";
  protected final String TEXT_303 = "+ deletedCount_";
  protected final String TEXT_304 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_305 = "=nb_line_update_";
  protected final String TEXT_306 = " + updatedCount_";
  protected final String TEXT_307 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_308 = "=nb_line_inserted_";
  protected final String TEXT_309 = " + insertedCount_";
  protected final String TEXT_310 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_311 = "=nb_line_rejected_";
  protected final String TEXT_312 = " + rejectedCount_";
  protected final String TEXT_313 = ";" + NL + "\t";
  protected final String TEXT_314 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_315 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_316 = "_NB_LINE\",nb_line_";
  protected final String TEXT_317 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_318 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_319 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_320 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_321 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_322 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_323 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_324 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_325 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_326 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_327 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_328 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_329 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_330 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_331 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_332 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_333 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_334 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_335 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_336 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_337 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_338 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_339 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_340 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_341 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_342 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_343 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
  protected final String TEXT_344 = ");" + NL + "        }" + NL + "\t";
  protected final String TEXT_345 = NL + "        globalMap.put(\"";
  protected final String TEXT_346 = "_NB_LINE\",nb_line_";
  protected final String TEXT_347 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_348 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_349 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_350 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_351 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_352 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_353 = ");" + NL + "        globalMap.put(\"";
  protected final String TEXT_354 = "_NB_LINE_REJECTED\", nb_line_rejected_";
