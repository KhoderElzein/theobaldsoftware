...
public class FooterJava
{
  ...
  protected final String TEXT_102 = "_value));" + NL + "" + NL + "            }catch(ParseException e)" + NL + "            {";
  protected final String TEXT_103 = NL + "                    log.warn(String.format(\"";
  protected final String TEXT_104 = "\", \"";
  protected final String TEXT_105 = "\", e.getMessage()));";
  protected final String TEXT_106 = NL + "                    System.err.println(String.format(\"";
  protected final String TEXT_107 = "\", \"";
  protected final String TEXT_108 = "\", e.getMessage()));";
  protected final String TEXT_109 = NL + "                context.";
  protected final String TEXT_110 = "=null;" + NL + "            }";
  protected final String TEXT_111 = NL + "                context.";
  protected final String TEXT_112 = "=(";
  protected final String TEXT_113 = ") context.getProperty(\"";
  protected final String TEXT_114 = "\");";
  protected final String TEXT_115 = NL + "             context.";
  protected final String TEXT_116 = "= new java.text.StringCharacterIterator(context.getProperty(\"";
  protected final String TEXT_117 = "\")).first();";
  protected final String TEXT_118 = NL + "             try{" + NL + "                 context.";
  protected final String TEXT_119 = "=routines.system.ParserUtils.parseTo_";
  protected final String TEXT_120 = " (context.getProperty(\"";
  protected final String TEXT_121 = "\"));" + NL + "             }catch(NumberFormatException e){";
  protected final String TEXT_122 = NL + "                    log.warn(String.format(\"";
  protected final String TEXT_123 = "\", \"";
  protected final String TEXT_124 = "\", e.getMessage()));";
  protected final String TEXT_125 = NL + "                    System.err.println(String.format(\"";
  protected final String TEXT_126 = "\", \"";
  protected final String TEXT_127 = "\", e.getMessage()));";
  protected final String TEXT_128 = NL + "                 context.";
  protected final String TEXT_129 = "=null;" + NL + "              }";
  protected final String TEXT_130 = NL + "        } catch (java.io.IOException ie) {" + NL + "            System.err.println(\"Could not load context \"+contextStr);" + NL + "            ie.printStackTrace();" + NL + "        }" + NL + "" + NL + "" + NL + "        // get context value from parent directly" + NL + "        if (parentContextMap != null && !parentContextMap.isEmpty()) {";
  protected final String TEXT_131 = "if (parentContextMap.containsKey(\"";
  protected final String TEXT_132 = "\")) {" + NL + "                context.";
  protected final String TEXT_133 = " = (";
  protected final String TEXT_134 = ") parentContextMap.get(\"";
  protected final String TEXT_135 = "\");" + NL + "            }";
  protected final String TEXT_136 = NL + "        }" + NL + "" + NL + "        //Resume: init the resumeUtil" + NL + "        resumeEntryMethodName = ResumeUtil.getResumeEntryMethodName(resuming_checkpoint_path);" + NL + "        resumeUtil = new ResumeUtil(resuming_logs_dir_path, isChildJob, rootPid);" + NL + "        resumeUtil.initCommonInfo(pid, rootPid, fatherPid, projectName, jobName, contextStr, jobVersion);" + NL + "" + NL + "\t\tList<String> parametersToEncrypt = new java.util.ArrayList<String>();";
  protected final String TEXT_137 = NL + "\t\t\tparametersToEncrypt.add(\"";
  ...
  protected final String TEXT_146 = NL + "\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap = new java.util.concurrent.ConcurrentHashMap<Object, Object>();" + NL + "\t    globalMap.put(\"concurrentHashMap\", concurrentHashMap);" + NL + "\t";
  protected final String TEXT_147 = NL + NL + "    long startUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "    long endUsedMemory = 0;" + NL + "    long end = 0;" + NL + "" + NL + "    startTime = System.currentTimeMillis();";
  protected final String TEXT_148 = NL + "        ";
  protected final String TEXT_149 = ".addMessage(\"begin\");";
  protected final String TEXT_150 = NL;
  protected final String TEXT_151 = NL + "    System.err.println(\"Only one hadoop configuration is allowed in one job!\");";
  protected final String TEXT_152 = NL;
  protected final String TEXT_153 = NL;
  protected final String TEXT_154 = NL;
  protected final String TEXT_155 = NL;
  protected final String TEXT_156 = NL + NL + "this.globalResumeTicket = true;//to run tPreJob" + NL;
  ...
  protected final String TEXT_162 = NL + NL + "this.globalResumeTicket = false;//to run others jobs" + NL;
  protected final String TEXT_163 = "final Thread launchingThread = Thread.currentThread();";
  protected final String TEXT_164 = NL + "        runningThreadCount.add(1);" + NL + "        new Thread(){" + NL + "            public void run() {" + NL + "                java.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "                threadRunResultMap.put(\"errorCode\", null);" + NL + "                threadRunResultMap.put(\"status\", \"\");" + NL + "                threadLocal.set(threadRunResultMap);" + NL;
  protected final String TEXT_165 = NL + "                ";
  protected final String TEXT_166 = NL + "                finally {" + NL + "                    Integer localErrorCode = (Integer)(((java.util.Map)threadLocal.get()).get(\"errorCode\"));" + NL + "                    String localStatus = (String)(((java.util.Map)threadLocal.get()).get(\"status\"));" + NL + "                    if (localErrorCode != null) {" + NL + "                        if (errorCode == null || localErrorCode.compareTo(errorCode) > 0) {" + NL + "                           errorCode = localErrorCode;" + NL + "                        }" + NL + "                    }" + NL + "                    if (!status.equals(\"failure\")){" + NL + "                        status = localStatus;" + NL + "                    }" + NL + "" + NL + "                    if (\"true\".equals(((java.util.Map) threadLocal.get()).get(\"JobInterrupted\"))) {" + NL + "                        launchingThread.interrupt();" + NL + "                    }" + NL + "" + NL + "                    runningThreadCount.add(-1);" + NL + "                }" + NL + "            }" + NL + "        }.start();" + NL;
  protected final String TEXT_167 = NL + "    boolean interrupted = false;" + NL + "    while (runningThreadCount.getCount() > 0) {" + NL + "        try {" + NL + "            Thread.sleep(10);" + NL + "        } catch (java.lang.InterruptedException e) {" + NL + "            interrupted = true;" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    if (interrupted) {" + NL + "        Thread.currentThread().interrupt();" + NL + "    }" + NL + NL;
  protected final String TEXT_168 = NL;
  protected final String TEXT_169 = NL + NL + "this.globalResumeTicket = true;//to run tPostJob" + NL;
  ...
  protected final String TEXT_176 = ".addMessage(status==\"\"?\"end\":status, (end-startTime));" + NL + "        try {";
  protected final String TEXT_177 = NL + "            ";
  protected final String TEXT_178 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_179 = NL;
  protected final String TEXT_180 = NL + "    closeJmsConnections();";
  protected final String TEXT_181 = NL;
  protected final String TEXT_182 = NL + "    closeScpConnections();";
  protected final String TEXT_183 = NL;
  protected final String TEXT_184 = NL + "if (execStat) {" + NL + "    runStat.updateStatOnJob(RunStat.JOBEND, fatherNode);" + NL + "    runStat.stopThreadStat();" + NL + "}";
  protected final String TEXT_185 = NL + "        runTrace.stopThreadTrace();";
  protected final String TEXT_186 = NL + "    int returnCode = 0;" + NL + "    if(errorCode == null) {" + NL + "         returnCode = status != null && status.equals(\"failure\") ? 1 : 0;" + NL + "    } else {" + NL + "         returnCode = errorCode.intValue();" + NL + "    }" + NL + "    resumeUtil.addLog(\"JOB_ENDED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\" + returnCode,\"\",\"\",\"\");" + NL + "" + NL + "    return returnCode;" + NL + "" + NL + "  }" + NL + "" + NL + "    // only for OSGi env" + NL + "    public void destroy() {";
  protected final String TEXT_187 = NL + "    closeJmsConnections();";
  protected final String TEXT_188 = NL + "    closeScpConnections();";
  protected final String TEXT_189 = NL + "    closeSqlDbConnections();";
  protected final String TEXT_190 = NL + "    closeCassandraConnections();";
  protected final String TEXT_191 = NL + "    closeHBaseConnections();";
  protected final String TEXT_192 = NL + "    closeFtpConnections();";
  protected final String TEXT_193 = NL + "    closeS3Connections();";
  protected final String TEXT_194 = NL + "    closeLDAPConnections();";
  protected final String TEXT_195 = NL + "    closeMDMConnections();";
  protected final String TEXT_196 = NL + "    closePaloConnections();";
  protected final String TEXT_197 = NL + "    closeEXistConnections();";
  protected final String TEXT_198 = NL + "    closeGSConnections();";
  protected final String TEXT_199 = NL + NL + NL + "    }" + NL;
  protected final String TEXT_200 = NL + "    private void closeJmsConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_201 = NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_202 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((javax.jms.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_203 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_204 = NL;
  protected final String TEXT_205 = NL + "    private void closeScpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_206 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_207 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((ch.ethz.ssh2.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_208 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_209 = NL;
  protected final String TEXT_210 = NL + "    private void closeSqlDbConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_211 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_212 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((java.sql.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_213 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_214 = NL;
  protected final String TEXT_215 = NL + "    private void closeCassandraConnections() {" + NL + "        try {" + NL + "            Object obj_cluster;" + NL + "            Object obj_conn;";
  protected final String TEXT_216 = NL + "            obj_cluster = globalMap.remove(\"cluster_";
  protected final String TEXT_217 = "\");" + NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_218 = "\");" + NL + "            if(obj_conn != null) {" + NL + "                ((com.datastax.driver.core.Session) obj_conn).close();" + NL + "            }" + NL + "            if(obj_cluster != null) {" + NL + "                ((com.datastax.driver.core.Cluster) obj_cluster).close();" + NL + "            }";
  protected final String TEXT_219 = NL + "            obj_conn = globalMap.remove(\"cluster_";
  protected final String TEXT_220 = "\");" + NL + "            if(obj_conn!=null) {" + NL + "                ((me.prettyprint.hector.api.Cluster) obj_conn).getConnectionManager().shutdown();" + NL + "            }";
  protected final String TEXT_221 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_222 = NL;
  protected final String TEXT_223 = NL + "    private void closeHBaseConnections() {" + NL + "        try {";
  protected final String TEXT_224 = NL + "   \t\t\torg.apache.hadoop.conf.Configuration conn_";
  protected final String TEXT_225 = " =(org.apache.hadoop.conf.Configuration)globalMap.get(\"conn_";
  protected final String TEXT_226 = "\");" + NL + "\t\t\tif(conn_";
  protected final String TEXT_227 = " != null )" + NL + "\t        {" + NL + "\t\t\t";
  protected final String TEXT_228 = NL + "\t\t        org.apache.hadoop.hbase.client.HConnection hConnection_";
  protected final String TEXT_229 = " = org.apache.hadoop.hbase.client.HConnectionManager.getConnection(conn_";
  protected final String TEXT_230 = ");" + NL + "\t\t        if ((hConnection_";
  protected final String TEXT_231 = " != null) && (!hConnection_";
  protected final String TEXT_232 = ".isClosed())) {" + NL + "\t\t\t\t    hConnection_";
  protected final String TEXT_233 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_234 = NL + "\t\t\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_235 = ",true);" + NL + "\t\t\t";
  protected final String TEXT_236 = NL + "\t\t\t}" + NL + "      globalMap.remove(\"conn_";
  protected final String TEXT_237 = "\");" + NL + "\t";
  protected final String TEXT_238 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_239 = NL;
  protected final String TEXT_240 = NL + "    private void closeFtpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_241 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_242 = "\");" + NL + "            if (obj_conn != null) {";
  protected final String TEXT_243 = NL + "                ((com.enterprisedt.net.ftp.FTPClient) obj_conn).quit();";
  protected final String TEXT_244 = NL + "                ((com.jcraft.jsch.ChannelSftp) obj_conn).quit();";
  protected final String TEXT_245 = NL + "                ((org.apache.commons.net.ftp.FTPSClient) obj_conn).disconnect();";
  protected final String TEXT_246 = NL + "            }";
  protected final String TEXT_247 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_248 = NL;
  protected final String TEXT_249 = NL + "    private void closeS3Connections() {" + NL + "        try {";
  protected final String TEXT_250 = NL + "    \tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_251 = " = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get(\"conn_";
  protected final String TEXT_252 = "\");" + NL + "\t    if(conn_";
  protected final String TEXT_253 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_254 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_255 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_256 = NL;
  protected final String TEXT_257 = NL + "    private void closeLDAPConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_258 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_259 = "\");" + NL + "            if (obj_conn != null) {" + NL + "                ((javax.naming.ldap.InitialLdapContext) obj_conn).close();" + NL + "            }";
  protected final String TEXT_260 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_261 = NL;
  protected final String TEXT_262 = NL + "    private void closeMDMConnections() {" + NL + "        try {" + NL + "            java.util.Iterator keySets = globalMap.keySet().iterator();" + NL + "            while (keySets.hasNext()) {" + NL + "                String key = keySets.next().toString();" + NL + "                if (key.startsWith(\"TMDMService_tMDMConnection_\")) {" + NL + "                    org.talend.mdm.webservice.TMDMService service = (org.talend.mdm.webservice.TMDMService)globalMap.get(key);" + NL + "                    if (service != null) {" + NL + "                        service.logout(new org.talend.mdm.webservice.WSLogout());" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_263 = NL + NL;
  protected final String TEXT_264 = NL + "    private void closePaloConnections() {" + NL + "        try {";
  protected final String TEXT_265 = NL + "    \torg.talend.jpalo.paloconnection pConn_";
  protected final String TEXT_266 = " = (org.talend.jpalo.paloconnection)globalMap.get(\"pConn_";
  protected final String TEXT_267 = "\");" + NL + "\t    if(pConn_";
  protected final String TEXT_268 = " !=null){" + NL + "\t\t\t\t\tpConn_";
  protected final String TEXT_269 = ".logout();" + NL + "" + NL + "\t\t}";
  protected final String TEXT_270 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_271 = NL;
  protected final String TEXT_272 = NL + "    private void closeEXistConnections() {" + NL + "        try {";
  protected final String TEXT_273 = NL + "\t\torg.xmldb.api.base.Collection col_";
  protected final String TEXT_274 = " = (org.xmldb.api.base.Collection)globalMap.get(\"col_";
  protected final String TEXT_275 = "\");" + NL + "\t    if(col_";
  protected final String TEXT_276 = " !=null){" + NL + "\t\t\t\t\tcol_";
  protected final String TEXT_277 = ".close();" + NL + "" + NL + "\t\t}";
  protected final String TEXT_278 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_279 = NL;
  protected final String TEXT_280 = NL + "    private void closeGSConnections() {" + NL + "        try {";
  protected final String TEXT_281 = NL + "\t\torg.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_282 = " =" + NL + "\t\t\t\t(org.jets3t.service.impl.rest.httpclient.GoogleStorageService)globalMap.get(\"service_";
  protected final String TEXT_283 = "\");" + NL + "\t\tif(service_";
  protected final String TEXT_284 = " !=null){" + NL + "\t\t\t\tservice_";
  protected final String TEXT_285 = ".shutdown();" + NL + "\t    }" + NL;
  protected final String TEXT_286 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_287 = NL + NL + "    private java.util.Map<String, Object> getSharedConnections4REST() {" + NL + "        java.util.Map<String, Object> connections = new java.util.HashMap<String, Object>();";
  protected final String TEXT_288 = NL + "            connections.put(\"connection_";
  protected final String TEXT_289 = "\", globalMap.get(\"connection_";
  protected final String TEXT_290 = "\"));" + NL + "            connections.put(\"session_";
  protected final String TEXT_291 = "\", globalMap.get(\"session_";
