...
public class TLogRowEndJava
{
  ...
  protected final String TEXT_45 = NL + NL + "                    " + NL + "                    java.io.PrintStream consoleOut_";
  protected final String TEXT_46 = " = null;" + NL + "                    if (globalMap.get(\"tLogRow_CONSOLE\")!=null)" + NL + "                    {" + NL + "                    \tconsoleOut_";
  protected final String TEXT_47 = " = (java.io.PrintStream) globalMap.get(\"tLogRow_CONSOLE\");" + NL + "                    }" + NL + "                    else" + NL + "                    {" + NL + "                    \tconsoleOut_";
  protected final String TEXT_48 = " = new java.io.PrintStream(new java.io.BufferedOutputStream(System.out));" + NL + "                    \tglobalMap.put(\"tLogRow_CONSOLE\",consoleOut_";
  protected final String TEXT_49 = ");" + NL + "                    }" + NL + "                    " + NL + "                    consoleOut_";
  protected final String TEXT_50 = ".println(util_";
  protected final String TEXT_51 = ".format().toString());" + NL + "                    consoleOut_";
  protected final String TEXT_52 = ".flush();";
