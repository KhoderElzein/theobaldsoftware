...
public class TMSSqlInputEndJava
{
  ...
  protected final String TEXT_76 = NL + "\t}" + NL + "}finally{" + NL + "\tif (rs_";
  protected final String TEXT_77 = " != null) {" + NL + "\t\trs_";
  protected final String TEXT_78 = ".close();" + NL + "\t}" + NL + "\tif (stmt_";
  protected final String TEXT_79 = " != null) {" + NL + "\t\tstmt_";
  protected final String TEXT_80 = ".close();" + NL + "\t}";
  protected final String TEXT_81 = NL + "\t\tif(conn_";
  protected final String TEXT_82 = " != null && !conn_";
  protected final String TEXT_83 = ".isClosed()) {";
  protected final String TEXT_84 = NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t";
  protected final String TEXT_86 = NL + "\t\t}";
  protected final String TEXT_87 = NL + "}" + NL + "globalMap.put(\"";
