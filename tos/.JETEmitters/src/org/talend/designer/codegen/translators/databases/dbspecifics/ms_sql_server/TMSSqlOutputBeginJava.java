...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_48 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_49 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_50 = " = 0;" + NL + "int nb_line_rejected_";
  ...
  protected final String TEXT_54 = "=0;" + NL + "int rejectedCount_";
  protected final String TEXT_55 = "=0;" + NL + "String dbschema_";
  protected final String TEXT_56 = " = null;" + NL + "String tableName_";
  protected final String TEXT_57 = " = null;" + NL + "boolean whetherReject_";
  protected final String TEXT_58 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_59 = " = java.util.Calendar.getInstance();" + NL + "long year1_";
  protected final String TEXT_60 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"0001-01-01\").getTime();" + NL + "long year2_";
  protected final String TEXT_61 = " = TalendDate.parseDate(\"yyyy-MM-dd\",\"1753-01-01\").getTime();" + NL + "long year10000_";
  protected final String TEXT_62 = " = TalendDate.parseDate(\"yyyy-MM-dd HH:mm:ss\",\"9999-12-31 24:00:00\").getTime();" + NL + "long date_";
  protected final String TEXT_63 = ";" + NL + "" + NL + "java.util.Calendar calendar_datetimeoffset_";
  protected final String TEXT_64 = " = java.util.Calendar.getInstance(java.util.TimeZone.getTimeZone(\"UTC\"));" + NL;
  protected final String TEXT_65 = NL;
  protected final String TEXT_66 = NL + "        int updateKeyCount_";
  protected final String TEXT_67 = " = ";
  protected final String TEXT_68 = ";" + NL + "        if(updateKeyCount_";
  protected final String TEXT_69 = " < 1) {" + NL + "            throw new RuntimeException(\"For update, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_70 = NL + "        int deleteKeyCount_";
  protected final String TEXT_71 = " = ";
  protected final String TEXT_72 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_73 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_74 = NL + "        int insertKeyCount_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";" + NL + "        if(insertKeyCount_";
  protected final String TEXT_77 = " < 1) {" + NL + "            throw new RuntimeException(\"For insert if not exist, Schema must have a key\");" + NL + "        }";
  protected final String TEXT_78 = NL + "\t";
  protected final String TEXT_79 = NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_90 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_91 = " = ";
  protected final String TEXT_92 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_93 = ".get(dsAlias_";
  protected final String TEXT_94 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_95 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_96 = " = dataSources_";
  protected final String TEXT_97 = ".get(dsAlias_";
  protected final String TEXT_98 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_99 = NL + "    dbschema_";
  protected final String TEXT_100 = " = ";
  protected final String TEXT_101 = ";";
  protected final String TEXT_102 = NL + "    String driverClass_";
  protected final String TEXT_103 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_104 = NL + "    String driverClass_";
  protected final String TEXT_105 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_106 = NL + "\t";
  protected final String TEXT_107 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_108 = ");" + NL + "    String port_";
  protected final String TEXT_109 = " = ";
  protected final String TEXT_110 = ";" + NL + "    String dbname_";
  protected final String TEXT_111 = " = ";
  protected final String TEXT_112 = " ;";
  protected final String TEXT_113 = NL + "    String url_";
  protected final String TEXT_114 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_115 = " ;";
  protected final String TEXT_116 = NL + "    String url_";
  protected final String TEXT_117 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_118 = " ;";
  protected final String TEXT_119 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_120 = ")) {" + NL + "    \turl_";
  protected final String TEXT_121 = " += \":\" + ";
  protected final String TEXT_122 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_123 = ")) {";
  protected final String TEXT_124 = NL + "\t\t\t\turl_";
  protected final String TEXT_125 = " += \"//\" + ";
  protected final String TEXT_126 = "; " + NL + "\t";
  protected final String TEXT_127 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_128 = " += \";databaseName=\" + ";
  protected final String TEXT_129 = "; " + NL + "\t";
  protected final String TEXT_130 = NL + "    }" + NL + "    url_";
  protected final String TEXT_131 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_132 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_142 = NL + NL + "    String dbPwd_";
  ...
  protected final String TEXT_152 = NL + "\t\tresourceMap.put(\"conn_";
  protected final String TEXT_153 = "\", conn_";
  protected final String TEXT_154 = ");" + NL + "\t";
  protected final String TEXT_155 = NL + "        conn_";
  protected final String TEXT_156 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_157 = " = ";
  protected final String TEXT_158 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_159 = " = 0;" + NL;
  protected final String TEXT_160 = NL + "   int batchSize_";
  protected final String TEXT_161 = " = ";
  protected final String TEXT_162 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_163 = "=0;";
  protected final String TEXT_164 = NL + NL + "if(dbschema_";
  protected final String TEXT_165 = " == null || dbschema_";
  protected final String TEXT_166 = ".trim().length() == 0) {" + NL + "    tableName_";
  protected final String TEXT_167 = " = ";
  protected final String TEXT_168 = ";" + NL + "} else {" + NL + "    tableName_";
  protected final String TEXT_169 = " = dbschema_";
  protected final String TEXT_170 = " + \"].[\" + ";
  protected final String TEXT_171 = ";" + NL + "}";
  protected final String TEXT_172 = NL + "\tint count_";
  protected final String TEXT_173 = "=0;" + NL;
  protected final String TEXT_174 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_186 = ".commit();";
  protected final String TEXT_187 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_188 = " = conn_";
  protected final String TEXT_189 = ".createStatement()) {";
  protected final String TEXT_190 = NL + "                              stmtCreate_";
  protected final String TEXT_191 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_192 = "));";
  protected final String TEXT_193 = NL + "                        stmtCreate_";
  protected final String TEXT_194 = ".execute(((\"";
  protected final String TEXT_195 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_196 = ".";
  protected final String TEXT_197 = ", \"";
  protected final String TEXT_198 = "\")";
  protected final String TEXT_199 = ".toUpperCase()";
  protected final String TEXT_200 = ")+\")";
  protected final String TEXT_201 = "\"));";
  protected final String TEXT_202 = NL + "                stmtCreate_";
  protected final String TEXT_203 = ".execute(\"";
  protected final String TEXT_204 = ")\");";
  protected final String TEXT_205 = NL + "            }";
  protected final String TEXT_206 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_207 = " = conn_";
  protected final String TEXT_208 = ".createStatement()) {";
  protected final String TEXT_209 = NL + "                              stmtCreate_";
  protected final String TEXT_210 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_211 = "));";
  protected final String TEXT_212 = NL + "                    stmtCreate_";
  protected final String TEXT_213 = ".execute(((\"";
  protected final String TEXT_214 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_215 = ".";
  protected final String TEXT_216 = ", \"";
  protected final String TEXT_217 = "\")";
  protected final String TEXT_218 = ".toUpperCase()";
  ...
  protected final String TEXT_242 = NL + "                                boolean whetherExist_";
  protected final String TEXT_243 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_244 = " = conn_";
  protected final String TEXT_245 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  ...
  protected final String TEXT_249 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_250 = NL + "                                ";
  protected final String TEXT_251 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_252 = " = conn_";
  protected final String TEXT_253 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_254 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_255 = " = tableNameForSearch_";
  protected final String TEXT_256 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_257 = " = tableNameForSearch_";
  protected final String TEXT_258 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  ...
  protected final String TEXT_263 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_264 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_265 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_266 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_267 = " = conn_";
  protected final String TEXT_268 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_269 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_270 = " = dbMetaData_";
  protected final String TEXT_271 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_286 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_287 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_290 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_291 = " = dbMetaData_";
  protected final String TEXT_292 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_311 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_312 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_313 = " = conn_";
  protected final String TEXT_314 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_315 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_316 = " = dbMetaData_";
  protected final String TEXT_317 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_318 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_319 = " == null || dbschema_";
  protected final String TEXT_320 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_321 = " = conn_";
  protected final String TEXT_322 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_323 = " = stmtSchema_";
  protected final String TEXT_324 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_325 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_326 = " = rsSchema_";
  protected final String TEXT_327 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_328 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_329 = " = rsTable_";
  protected final String TEXT_330 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_331 = " = rsTable_";
  protected final String TEXT_332 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_333 = ".equals";
  protected final String TEXT_334 = "IgnoreCase";
  protected final String TEXT_335 = "(";
  protected final String TEXT_336 = ")" + NL + "                                            && (schema_";
  protected final String TEXT_337 = ".equals";
  protected final String TEXT_338 = "IgnoreCase";
  protected final String TEXT_339 = "(dbschema_";
  protected final String TEXT_340 = ") || ((dbschema_";
  protected final String TEXT_341 = " ==null || dbschema_";
  protected final String TEXT_342 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_343 = ".equals";
  protected final String TEXT_344 = "IgnoreCase";
  protected final String TEXT_345 = "(schema_";
  protected final String TEXT_346 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_347 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_348 = NL + "                                String tableForSearch_";
  protected final String TEXT_349 = " = ";
  protected final String TEXT_350 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_351 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_352 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_353 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_354 = " =  tableForSearch_";
  protected final String TEXT_355 = ".substring(1,tableForSearch_";
  protected final String TEXT_356 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_357 = " =  tableForSearch_";
  protected final String TEXT_358 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_359 = " = conn_";
  protected final String TEXT_360 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_361 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_362 = " = dbMetaData_";
  protected final String TEXT_363 = ".getTables(null, conn_";
  protected final String TEXT_364 = ".getSchema(), tableForSearch_";
  protected final String TEXT_365 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_366 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_367 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_368 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_373 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_374 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_375 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_376 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_377 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_378 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_379 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_380 = " = conn_";
  protected final String TEXT_381 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_382 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_383 = " = dbMetaData_";
  protected final String TEXT_384 = ".getTables(";
  protected final String TEXT_385 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_386 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_387 = " = rsTable_";
  protected final String TEXT_388 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_389 = ".equalsIgnoreCase(";
  protected final String TEXT_390 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_391 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_392 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_393 = " = conn_";
  protected final String TEXT_394 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_395 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_396 = " = dbMetaData_";
  protected final String TEXT_397 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_398 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_399 = " = rsTable_";
  protected final String TEXT_400 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_401 = ".equalsIgnoreCase(";
  protected final String TEXT_402 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_403 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_404 = NL + "                                if(!whetherExist_";
  protected final String TEXT_405 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_406 = " = conn_";
  protected final String TEXT_407 = ".createStatement()) {";
  protected final String TEXT_408 = NL + "                                                      stmtCreate_";
  protected final String TEXT_409 = ".setQueryTimeout(Integer.valueOf(";
  ...
  protected final String TEXT_424 = NL + "                                if(whetherExist_";
  protected final String TEXT_425 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_438 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_439 = " = conn_";
  protected final String TEXT_440 = ".createStatement()) {";
  protected final String TEXT_441 = NL + "                                                  stmtCreate_";
  protected final String TEXT_442 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_443 = "));";
  protected final String TEXT_444 = NL + "                                        stmtCreate_";
  protected final String TEXT_445 = ".execute(((\"";
  protected final String TEXT_446 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_453 = NL + "                                    stmtCreate_";
  protected final String TEXT_454 = ".execute(\"";
  protected final String TEXT_455 = ")\");";
  protected final String TEXT_456 = NL + "                                }";
  protected final String TEXT_457 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_458 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_459 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_460 = " = conn_";
  protected final String TEXT_461 = ".createStatement()) {";
  protected final String TEXT_462 = NL + "                              stmtClear_";
  protected final String TEXT_463 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_464 = "));";
  protected final String TEXT_465 = NL + "                stmtClear_";
  protected final String TEXT_466 = ".executeUpdate(\"";
  protected final String TEXT_467 = "\");";
  protected final String TEXT_468 = NL + "            }";
  protected final String TEXT_469 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_470 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_471 = " = conn_";
  protected final String TEXT_472 = ".createStatement()) {";
  protected final String TEXT_473 = NL + "                              stmtTruncCount_";
  protected final String TEXT_474 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_475 = "));";
  protected final String TEXT_476 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_477 = " = stmtTruncCount_";
  protected final String TEXT_478 = ".executeQuery(\"";
  protected final String TEXT_479 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_480 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_481 = " = rsTruncCount_";
  protected final String TEXT_482 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_483 = " = conn_";
  protected final String TEXT_484 = ".createStatement()) {";
  protected final String TEXT_485 = NL + "                              stmtTrunc_";
  protected final String TEXT_486 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_487 = "));";
  protected final String TEXT_488 = NL + "                conn_";
  protected final String TEXT_489 = ".commit();";
  protected final String TEXT_490 = NL + "                stmtTrunc_";
  protected final String TEXT_491 = ".executeUpdate(\"";
  protected final String TEXT_492 = "\");";
  protected final String TEXT_493 = NL + "                    if(!conn_";
  protected final String TEXT_494 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_495 = ".commit();" + NL + "                    }";
  protected final String TEXT_496 = NL + "                deletedCount_";
  protected final String TEXT_497 = " += rsTruncCountNumber_";
  protected final String TEXT_498 = ";" + NL + "            }";
  protected final String TEXT_499 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_502 = " = stmtTruncCount_";
  protected final String TEXT_503 = ".executeQuery(\"";
  protected final String TEXT_504 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  protected final String TEXT_505 = " = conn_";
  protected final String TEXT_506 = ".createStatement()) {";
  protected final String TEXT_507 = NL + "                conn_";
  protected final String TEXT_508 = ".commit();";
  protected final String TEXT_509 = NL + "                stmtTrunc_";
  protected final String TEXT_510 = ".executeUpdate(\"";
  protected final String TEXT_511 = "\");";
  protected final String TEXT_512 = NL + "                while(rsTruncCount_";
  protected final String TEXT_513 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_514 = " += rsTruncCount_";
  protected final String TEXT_515 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_524 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_525 = "\", pstmt_";
  protected final String TEXT_526 = ");";
  protected final String TEXT_527 = NL;
  protected final String TEXT_528 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_529 = " = null;" + NL + "        String keyPsmt_";
  protected final String TEXT_530 = " = conn_";
  protected final String TEXT_531 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_532 = " + \"]\";" + NL + "        pstmt_";
  protected final String TEXT_533 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_534 = ",insert_";
  protected final String TEXT_535 = ",keyPsmt_";
  protected final String TEXT_536 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_546 = ");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_551 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_552 = " + \"] WHERE ";
  protected final String TEXT_553 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_554 = "\", pstmt_";
  protected final String TEXT_555 = ");" + NL + "        String insert_";
  protected final String TEXT_556 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_557 = " + \"] (";
  protected final String TEXT_558 = ") VALUES (";
  ...
  protected final String TEXT_562 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  ...
  protected final String TEXT_568 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_569 = " = conn_";
  protected final String TEXT_570 = ".prepareStatement(update_";
  protected final String TEXT_571 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_572 = "\", pstmtUpdate_";
  protected final String TEXT_573 = ");";
  protected final String TEXT_574 = NL + "        String update_";
  protected final String TEXT_575 = " = \"UPDATE [\" + tableName_";
  protected final String TEXT_576 = " + \"] SET ";
  protected final String TEXT_577 = " WHERE ";
  protected final String TEXT_578 = "\";" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_579 = " = conn_";
  protected final String TEXT_580 = ".prepareStatement(update_";
  protected final String TEXT_581 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_582 = "\", pstmtUpdate_";
  protected final String TEXT_583 = ");" + NL + "        String insert_";
  protected final String TEXT_584 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_585 = " + \"] (";
  protected final String TEXT_586 = ") VALUES (";
  protected final String TEXT_587 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_588 = " = conn_";
  protected final String TEXT_589 = ".prepareStatement(insert_";
  protected final String TEXT_590 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_591 = "\", pstmtInsert_";
  protected final String TEXT_592 = ");";
  protected final String TEXT_593 = NL + "        String delete_";
  protected final String TEXT_594 = " = \"DELETE FROM [\" + tableName_";
  ...
  protected final String TEXT_598 = ".prepareStatement(delete_";
  protected final String TEXT_599 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_600 = "\", pstmt_";
  protected final String TEXT_601 = ");";
  protected final String TEXT_602 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_603 = " = conn_";
  protected final String TEXT_604 = ".prepareStatement(\"SELECT COUNT(1) FROM [\" + tableName_";
  protected final String TEXT_605 = " + \"] WHERE ";
  protected final String TEXT_606 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_611 = ") VALUES (";
  protected final String TEXT_612 = ")\";" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_613 = " = conn_";
  protected final String TEXT_614 = ".prepareStatement(insert_";
  protected final String TEXT_615 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_616 = "\", pstmtInsert_";
  protected final String TEXT_617 = ");";
  protected final String TEXT_618 = NL + NL + "    class BufferLine_";
  protected final String TEXT_619 = " {";
  protected final String TEXT_620 = NL + "                ";
  protected final String TEXT_621 = " ";
  protected final String TEXT_622 = ";";
  protected final String TEXT_623 = NL + NL + "        public BufferLine_";
  protected final String TEXT_624 = "(";
  protected final String TEXT_625 = NL + "                    ,";
  protected final String TEXT_626 = NL + "                ";
  protected final String TEXT_627 = " ";
  protected final String TEXT_628 = NL + "        ){";
  protected final String TEXT_629 = NL + "                    this.";
  protected final String TEXT_630 = " = ";
  protected final String TEXT_631 = ";";
  protected final String TEXT_632 = NL + "        }" + NL + "    }" + NL + "" + NL + "    java.util.List<BufferLine_";
  protected final String TEXT_633 = "> sInsertColValueList";
  protected final String TEXT_634 = " = new java.util.ArrayList();" + NL + "    BufferLine_";
  protected final String TEXT_635 = " sInsertColValue";
  protected final String TEXT_636 = " = null;" + NL + "" + NL + "    StringBuilder extendInsertValueStmt_";
  protected final String TEXT_637 = " = new StringBuilder();" + NL + "    for(int i=0;i < ";
  protected final String TEXT_638 = ";i++){" + NL + "         extendInsertValueStmt_";
  protected final String TEXT_639 = ".append(\"(";
  protected final String TEXT_640 = ")\");" + NL + "         if (i!=";
  protected final String TEXT_641 = "-1) extendInsertValueStmt_";
  protected final String TEXT_642 = ".append(\",\");" + NL + "    }" + NL + "" + NL + "\tString insert_";
  protected final String TEXT_643 = " = \"INSERT INTO \"+";
  protected final String TEXT_644 = "+\" (";
  protected final String TEXT_645 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_646 = ".toString();" + NL + "" + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_647 = " =  conn_";
  protected final String TEXT_648 = ".prepareStatement(insert_";
  protected final String TEXT_649 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_650 = "\", pstmt_";
  protected final String TEXT_651 = ");" + NL + "" + NL + "    String insertColName";
  protected final String TEXT_652 = " = \"";
  protected final String TEXT_653 = "\";" + NL + "    String insertColValue";
  protected final String TEXT_654 = " =  \"";
  protected final String TEXT_655 = "\";" + NL + "    int rowCount";
  protected final String TEXT_656 = " = 0;";
  protected final String TEXT_657 = NL + "        StringBuffer query_";
  protected final String TEXT_658 = " = null;" + NL + "       \t";
  protected final String TEXT_659 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_660 = " = insert_";
  protected final String TEXT_661 = ".split(\"\\\\?\");";
  protected final String TEXT_662 = NL + "\t\t\tupdate_";
  protected final String TEXT_663 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_664 = " = update_";
  protected final String TEXT_665 = ".split(\"\\\\?\");";
  protected final String TEXT_666 = NL + "\t\t\tupdate_";
  protected final String TEXT_667 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_668 = " = update_";
  protected final String TEXT_669 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_670 = " = insert_";
  protected final String TEXT_671 = ".split(\"\\\\?\");";
  protected final String TEXT_672 = NL + "\t\t\tdelete_";
  protected final String TEXT_673 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_674 = " = delete_";
  protected final String TEXT_675 = ".split(\"\\\\?\");";
  protected final String TEXT_676 = NL + "\t\t\treplace_";
  protected final String TEXT_677 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_678 = " = replace_";
  protected final String TEXT_679 = ".split(\"\\\\?\");";
  protected final String TEXT_680 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_681 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_682 = " = insertIgnore_";
  protected final String TEXT_683 = ".split(\"\\\\?\");";
  protected final String TEXT_684 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_685 = " = insert_";
  protected final String TEXT_686 = ".split(\"\\\\?\");";
  protected final String TEXT_687 = NL + " \tboolean isShareIdentity_";
  protected final String TEXT_688 = " = globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_689 = "\") != null && (Boolean)globalMap.get(\"shareIdentitySetting_";
  protected final String TEXT_690 = "\") == true;";
  protected final String TEXT_691 = NL + "        java.sql.Statement stmt_";
  protected final String TEXT_692 = " = conn_";
  protected final String TEXT_693 = ".createStatement();";
  protected final String TEXT_694 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_695 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_696 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_697 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_698 = NL + "            stmt_";
  protected final String TEXT_699 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_700 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_701 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_702 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_703 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_704 = " =null;" + NL + "\t";
  protected final String TEXT_705 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_706 = " = null;" + NL + "\t\t";
  protected final String TEXT_707 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_708 = " = null;";
  protected final String TEXT_709 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_710 = " =  null;";
  protected final String TEXT_711 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_712 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_713 = " = null;";
  protected final String TEXT_714 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_715 = " = null;";
  protected final String TEXT_716 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_717 = " = null;";
  protected final String TEXT_718 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_719 = " = null;";
  protected final String TEXT_720 = NL + "\t\t \tString[] insertSQLSplits_";
