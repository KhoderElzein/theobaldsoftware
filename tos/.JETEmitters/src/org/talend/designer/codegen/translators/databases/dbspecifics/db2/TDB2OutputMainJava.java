package org.talend.designer.codegen.translators.databases.dbspecifics.db2;
...
public class TDB2OutputMainJava {
  ...
  protected final String TEXT_419 = ");" + NL + "\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_423 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_424 = " + \"\\\" SET ";
  protected final String TEXT_425 = ", \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_432 = NL + "\t\t\t\tString update_";
  protected final String TEXT_433 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_434 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_435 = ".";
  protected final String TEXT_436 = ", \"";
  protected final String TEXT_437 = "\")";
  protected final String TEXT_438 = ".toUpperCase()";
  ...
  protected final String TEXT_444 = ");" + NL + "\t\tresourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_454 = ".toUpperCase()";
  protected final String TEXT_455 = "+\") VALUES (";
  protected final String TEXT_456 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_457 = ".";
  protected final String TEXT_458 = ")+\")\";";
  protected final String TEXT_459 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_460 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_461 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_462 = ".";
  protected final String TEXT_463 = ", \"";
  protected final String TEXT_464 = "\")";
  protected final String TEXT_465 = ".toUpperCase()";
  ...
  protected final String TEXT_476 = ".toUpperCase()";
  ...
  protected final String TEXT_481 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_488 = NL + "\t    pstmt_";
  protected final String TEXT_489 = " = conn_";
  protected final String TEXT_490 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_491 = " + \"\\\" WHERE ";
  protected final String TEXT_492 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_493 = "\", pstmt_";
  ...
  protected final String TEXT_497 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_498 = "\", pstmtInsert_";
  protected final String TEXT_499 = ");" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_500 = " = conn_";
  protected final String TEXT_501 = ".prepareStatement(update_";
  protected final String TEXT_502 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_503 = "\", pstmtUpdate_";
  protected final String TEXT_504 = ");" + NL + "\t    ";
  protected final String TEXT_505 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_506 = " = \"INSERT INTO \\\"\" + tableName_";
  ...
  protected final String TEXT_523 = ".toUpperCase()";
  protected final String TEXT_524 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_525 = ".";
  protected final String TEXT_526 = ")+\")\";";
  protected final String TEXT_527 = NL + "\t\t\t\tString update_";
  protected final String TEXT_528 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_529 = " + \"\\\" SET ";
  protected final String TEXT_530 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_531 = ".";
  protected final String TEXT_532 = ", \"";
  protected final String TEXT_533 = "\")";
  protected final String TEXT_534 = ".toUpperCase()";
  ...
  protected final String TEXT_539 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_540 = ".";
  protected final String TEXT_541 = ", \"";
  protected final String TEXT_542 = "\")";
  protected final String TEXT_543 = ".toUpperCase()";
  protected final String TEXT_544 = "+\" WHERE ";
  protected final String TEXT_545 = "\";";
  protected final String TEXT_546 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_547 = " = conn_";
  protected final String TEXT_548 = ".prepareStatement(update_";
  protected final String TEXT_549 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_550 = "\", pstmtUpdate_";
  ...
  protected final String TEXT_589 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  ...
  protected final String TEXT_596 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_597 = " = buffersSize_";
  protected final String TEXT_598 = ";";
  protected final String TEXT_599 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_600 = " = buffersSize_";
  protected final String TEXT_601 = ";";
  protected final String TEXT_602 = NL + "        whetherReject_";
  protected final String TEXT_603 = " = false;";
  protected final String TEXT_604 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_605 = ".setInsert_";
  protected final String TEXT_606 = "(";
  protected final String TEXT_607 = ",pstmt_";
  protected final String TEXT_608 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_609 = ",query_";
  protected final String TEXT_610 = ",insertSQLSplits_";
  protected final String TEXT_611 = NL + "\t\t\t\t\t);";
  protected final String TEXT_612 = NL + "                    ";
  protected final String TEXT_613 = NL + "                        ";
  protected final String TEXT_614 = ";";
  protected final String TEXT_615 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_616 = ",";
  protected final String TEXT_617 = ".";
  protected final String TEXT_618 = ", ";
  protected final String TEXT_619 = ",insertSQLSplits_";
  ...
  protected final String TEXT_631 = NL + "        \t\tpstmt_";
  protected final String TEXT_632 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_633 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_634 = NL + "\t\t  \t\t\tbatchSizeCounter_";
  protected final String TEXT_635 = "++;" + NL + "    \t\t";
  protected final String TEXT_636 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_637 = "++;" + NL + "                insertedCount_";
  protected final String TEXT_638 = " = insertedCount_";
  protected final String TEXT_639 = " + pstmt_";
  protected final String TEXT_640 = ".executeUpdate();";
  protected final String TEXT_641 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_642 = " = true;";
  protected final String TEXT_643 = NL + "                    throw(e);";
  protected final String TEXT_644 = NL + "                        ";
  protected final String TEXT_645 = " = new ";
  protected final String TEXT_646 = "Struct();";
  protected final String TEXT_647 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_648 = ".assign_";
  ...
  protected final String TEXT_658 = NL + "                        rejectedCount_";
  protected final String TEXT_659 = " = rejectedCount_";
  protected final String TEXT_660 = " + 1;";
  protected final String TEXT_661 = NL + "                        ";
  protected final String TEXT_662 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_668 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_669 = ".setUpdate_";
  protected final String TEXT_670 = "(";
  protected final String TEXT_671 = ",pstmt_";
  protected final String TEXT_672 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_673 = ",query_";
  protected final String TEXT_674 = ",updateSQLSplits_";
  ...
  protected final String TEXT_680 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_681 = ",";
  protected final String TEXT_682 = ".";
  protected final String TEXT_683 = ", ";
  protected final String TEXT_684 = ",updateSQLSplits_";
  protected final String TEXT_685 = ");";
  protected final String TEXT_686 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_687 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_688 = ".";
  protected final String TEXT_689 = ", pstmt_";
  ...
  protected final String TEXT_711 = ".addBatch();" + NL + "        \t\tnb_line_";
  protected final String TEXT_712 = "++;" + NL + "    \t\t  \t";
  protected final String TEXT_713 = NL + "    \t\t  \t\tbatchSizeCounter_";
  protected final String TEXT_714 = "++;" + NL + "    \t\t";
  protected final String TEXT_715 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_716 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_717 = " = updatedCount_";
  protected final String TEXT_718 = " + pstmt_";
  protected final String TEXT_719 = ".executeUpdate();";
  protected final String TEXT_720 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_721 = " = true;";
  protected final String TEXT_722 = NL + "                    throw(e);";
  protected final String TEXT_723 = NL + "                        ";
  protected final String TEXT_724 = " = new ";
  protected final String TEXT_725 = "Struct();";
  protected final String TEXT_726 = NL + "                        \t\tdataPropagateUtil_";
  protected final String TEXT_727 = ".assign_";
  ...
  protected final String TEXT_737 = NL + "                        rejectedCount_";
  protected final String TEXT_738 = " = rejectedCount_";
  protected final String TEXT_739 = " + 1;";
  protected final String TEXT_740 = NL + "                        ";
  protected final String TEXT_741 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  ...
  protected final String TEXT_745 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_750 = NL + NL + "            int checkCount_";
  protected final String TEXT_751 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_752 = " = pstmt_";
  protected final String TEXT_753 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_754 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_755 = " = rs_";
  protected final String TEXT_756 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_757 = " > 0) {" + NL + "    \t\t\t";
  protected final String TEXT_758 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_759 = ".setUpdate_";
  protected final String TEXT_760 = "(";
  protected final String TEXT_761 = ",pstmtUpdate_";
  protected final String TEXT_762 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_763 = ",query_";
  protected final String TEXT_764 = ",updateSQLSplits_";
  ...
  protected final String TEXT_798 = NL + "                try {" + NL + "                    updatedCount_";
  ...
  protected final String TEXT_810 = "Struct();";
  protected final String TEXT_811 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_812 = ".assign_";
  ...
  protected final String TEXT_822 = NL + "                            rejectedCount_";
  protected final String TEXT_823 = " = rejectedCount_";
  protected final String TEXT_824 = " + 1;";
  protected final String TEXT_825 = NL + "                            ";
  protected final String TEXT_826 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_827 = NL + "                            ";
  protected final String TEXT_828 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_829 = ";";
  protected final String TEXT_830 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_831 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\t";
  protected final String TEXT_832 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_833 = ".setInsert_";
  protected final String TEXT_834 = "(";
  protected final String TEXT_835 = ",pstmtInsert_";
  protected final String TEXT_836 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_837 = ",query_";
  protected final String TEXT_838 = ",insertSQLSplits_";
  ...
  protected final String TEXT_858 = NL + "                try {" + NL + "                    insertedCount_";
  ...
  protected final String TEXT_863 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_864 = " = true;";
  protected final String TEXT_865 = NL + "                        throw(e);";
  protected final String TEXT_866 = NL + "                    \tnb_line_";
  protected final String TEXT_867 = "++;" + NL + "                    \t";
  protected final String TEXT_868 = NL + "                            ";
  protected final String TEXT_869 = " = new ";
  protected final String TEXT_870 = "Struct();";
  protected final String TEXT_871 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_872 = ".assign_";
  ...
  protected final String TEXT_882 = NL + "                            rejectedCount_";
  protected final String TEXT_883 = " = rejectedCount_";
  protected final String TEXT_884 = " + 1;";
  protected final String TEXT_885 = NL + "                            ";
  protected final String TEXT_886 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_887 = NL + "                            ";
  protected final String TEXT_888 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_889 = ";";
  protected final String TEXT_890 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_891 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\t";
  protected final String TEXT_892 = NL + "    \t    int updateFlag_";
  protected final String TEXT_893 = "=0;" + NL + "    \t    ";
  protected final String TEXT_894 = NL + "\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_895 = ".setUpdate_";
  protected final String TEXT_896 = "(";
  protected final String TEXT_897 = ",pstmtUpdate_";
  protected final String TEXT_898 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_899 = ",query_";
  protected final String TEXT_900 = ",updateSQLSplits_";
  protected final String TEXT_901 = NL + "\t\t\t\t\t);";
  protected final String TEXT_902 = NL + "                    ";
  protected final String TEXT_903 = NL + "                        ";
  protected final String TEXT_904 = ";";
  protected final String TEXT_905 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_906 = ",";
  protected final String TEXT_907 = ".";
  protected final String TEXT_908 = ", ";
  protected final String TEXT_909 = ",updateSQLSplits_";
  protected final String TEXT_910 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_911 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_912 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_913 = ".";
  protected final String TEXT_914 = ", pstmtUpdate_";
  ...
  protected final String TEXT_934 = ".toString().trim());";
  protected final String TEXT_935 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_936 = "=pstmtUpdate_";
  protected final String TEXT_937 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_938 = " = updatedCount_";
  protected final String TEXT_939 = " + updateFlag_";
  protected final String TEXT_940 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_941 = " == 0) {" + NL + "            \t";
  protected final String TEXT_942 = NL + "\t\t\t\tquery_";
  protected final String TEXT_943 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_944 = NL + "\t\t\t\t\t\tsetPrepareStatementUtil_";
  protected final String TEXT_945 = ".setInsert_";
  protected final String TEXT_946 = "(";
  protected final String TEXT_947 = ",pstmtInsert_";
  protected final String TEXT_948 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_949 = ",query_";
  protected final String TEXT_950 = ",insertSQLSplits_";
  ...
  protected final String TEXT_973 = ".executeUpdate();" + NL + "\t\t\t\t\tnb_line_";
  protected final String TEXT_974 = "++;";
  protected final String TEXT_975 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_976 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_977 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_978 = " = true;";
  protected final String TEXT_979 = NL + "                        throw(e);";
  protected final String TEXT_980 = NL + "                    \tnb_line_";
  ...
  protected final String TEXT_985 = NL + "                            \t\tdataPropagateUtil_";
  protected final String TEXT_986 = ".assign_";
  ...
  protected final String TEXT_996 = NL + "                            rejectedCount_";
  protected final String TEXT_997 = " = rejectedCount_";
  protected final String TEXT_998 = " + 1;";
  protected final String TEXT_999 = NL + "                            ";
  protected final String TEXT_1000 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1001 = NL + "                            ";
  protected final String TEXT_1002 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1003 = ";";
  protected final String TEXT_1004 = NL + "                            System.err.print(e.getMessage());";
  ...
  protected final String TEXT_1023 = NL + "            try {" + NL + "            \tdeletedCount_";
  protected final String TEXT_1024 = " = deletedCount_";
  protected final String TEXT_1025 = " + pstmt_";
  protected final String TEXT_1026 = ".executeUpdate();" + NL + "            \tnb_line_";
  protected final String TEXT_1027 = "++;";
  protected final String TEXT_1028 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_1029 = " = true;";
  protected final String TEXT_1030 = NL + "                    throw(e);";
  protected final String TEXT_1031 = NL + "                \tnb_line_";
  ...
  protected final String TEXT_1047 = NL + "                        rejectedCount_";
  protected final String TEXT_1048 = " = rejectedCount_";
  protected final String TEXT_1049 = " + 1;";
  protected final String TEXT_1050 = NL + "                        ";
  protected final String TEXT_1051 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_1052 = NL + "                        ";
  protected final String TEXT_1053 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_1054 = ";";
  protected final String TEXT_1055 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_1056 = NL + "            }";
  protected final String TEXT_1057 = NL + "    \t";
  protected final String TEXT_1058 = NL + "            if(!whetherReject_";
  protected final String TEXT_1059 = ") {";
  protected final String TEXT_1060 = NL + "                            ";
  protected final String TEXT_1061 = " = new ";
  protected final String TEXT_1062 = "Struct();";
  protected final String TEXT_1063 = NL + "                                \tdataPropagateUtil_";
  protected final String TEXT_1064 = ".assign_";
  ...
  protected final String TEXT_1075 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_1076 = " > 0) && (batchSize_";
  protected final String TEXT_1077 = " <= batchSizeCounter_";
  protected final String TEXT_1078 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_1079 = " = 0;" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1080 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1081 = ": pstmt_";
  protected final String TEXT_1082 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1083 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1084 = " += 1;" + NL + "        \t\t\t\t\t}else{" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1085 = " += (countEach_";
  protected final String TEXT_1086 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1087 = ");" + NL + "        \t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1088 = NL + "            \t    \t";
  protected final String TEXT_1089 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1090 = " += countSum_";
  protected final String TEXT_1091 = ";" + NL + "            \t    \t";
  protected final String TEXT_1092 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1093 = " += countSum_";
  protected final String TEXT_1094 = ";" + NL + "            \t    \t";
  protected final String TEXT_1095 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1096 = " += countSum_";
  protected final String TEXT_1097 = ";" + NL + "            \t    \t";
  protected final String TEXT_1098 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_1099 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1100 = "){" + NL + "    \t\t\tjava.sql.SQLException ne_";
  protected final String TEXT_1101 = " = e_";
  protected final String TEXT_1102 = ".getNextException(),sqle_";
  protected final String TEXT_1103 = "=null;" + NL + "    \t\t\tString errormessage_";
  protected final String TEXT_1104 = ";" + NL + "\t\t\t\tif (ne_";
  protected final String TEXT_1105 = " != null) {" + NL + "\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\tsqle_";
  protected final String TEXT_1106 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1107 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1108 = ".getMessage(), ne_";
  protected final String TEXT_1109 = ".getSQLState(), ne_";
  protected final String TEXT_1110 = ".getErrorCode(), ne_";
  protected final String TEXT_1111 = ");" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_1112 = " = sqle_";
  protected final String TEXT_1113 = ".getMessage();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_1114 = " = e_";
  protected final String TEXT_1115 = ".getMessage();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_1116 = NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1117 = " != null) {" + NL + "\t\t\t\t\t\tthrow(sqle_";
  protected final String TEXT_1118 = ");" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1119 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_1120 = NL + "\t\t\t\tSystem.err.println(errormessage_";
  protected final String TEXT_1121 = ");" + NL + "\t\t\t\tint countSum_";
  protected final String TEXT_1122 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_1123 = ": e_";
  protected final String TEXT_1124 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\tif(countEach_";
  protected final String TEXT_1125 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1126 = " += 1;" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1127 = " += (countEach_";
  protected final String TEXT_1128 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1129 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_1130 = NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_1131 = " += countSum_";
  protected final String TEXT_1132 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_1133 = NL + "\t\t\t\t\tupdatedCount_";
  protected final String TEXT_1134 = " += countSum_";
  protected final String TEXT_1135 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_1136 = NL + "\t\t\t\t\tdeletedCount_";
  protected final String TEXT_1137 = " += countSum_";
  protected final String TEXT_1138 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_1139 = NL + "\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_1140 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_1141 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_1142 = " <= commitCounter_";
  protected final String TEXT_1143 = ") {";
  protected final String TEXT_1144 = NL + "                if ((batchSize_";
  protected final String TEXT_1145 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_1146 = " > 0)) {" + NL + "                try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_1147 = " = 0;" + NL + "                \t\tint countSum_";
  protected final String TEXT_1148 = " = 0;" + NL + "                \t\t";
  protected final String TEXT_1149 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_1150 = ": pstmt_";
  protected final String TEXT_1151 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tif(countEach_";
  protected final String TEXT_1152 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1153 = " += 1;" + NL + "        \t\t\t\t\t}else{" + NL + "        \t\t\t\t\t\tcountSum_";
  protected final String TEXT_1154 = " += (countEach_";
  protected final String TEXT_1155 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1156 = ");" + NL + "        \t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_1157 = NL + "            \t    \t";
  protected final String TEXT_1158 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_1159 = " += countSum_";
  protected final String TEXT_1160 = ";" + NL + "            \t    \t";
  protected final String TEXT_1161 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_1162 = " += countSum_";
  protected final String TEXT_1163 = ";" + NL + "            \t    \t";
  protected final String TEXT_1164 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_1165 = " += countSum_";
  protected final String TEXT_1166 = ";" + NL + "            \t    \t";
  protected final String TEXT_1167 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_1168 = "){" + NL + "    \t\t\tjava.sql.SQLException ne_";
  protected final String TEXT_1169 = " = e_";
  protected final String TEXT_1170 = ".getNextException(),sqle_";
  protected final String TEXT_1171 = "=null;" + NL + "    \t\t\tString errormessage_";
  protected final String TEXT_1172 = ";" + NL + "\t\t\t\tif (ne_";
  protected final String TEXT_1173 = " != null) {" + NL + "\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\tsqle_";
  protected final String TEXT_1174 = " = new java.sql.SQLException(e_";
  protected final String TEXT_1175 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_1176 = ".getMessage(), ne_";
  protected final String TEXT_1177 = ".getSQLState(), ne_";
  protected final String TEXT_1178 = ".getErrorCode(), ne_";
  protected final String TEXT_1179 = ");" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_1180 = " = sqle_";
  protected final String TEXT_1181 = ".getMessage();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\terrormessage_";
  protected final String TEXT_1182 = " = e_";
  protected final String TEXT_1183 = ".getMessage();" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_1184 = NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_1185 = " != null) {" + NL + "\t\t\t\t\t\tthrow(sqle_";
  protected final String TEXT_1186 = ");" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tthrow(e_";
  protected final String TEXT_1187 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_1188 = NL + "\t\t\t\tSystem.err.println(errormessage_";
  protected final String TEXT_1189 = ");" + NL + "\t\t\t\tint countSum_";
  protected final String TEXT_1190 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_1191 = ": e_";
  protected final String TEXT_1192 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\tif(countEach_";
  protected final String TEXT_1193 = " == java.sql.Statement.SUCCESS_NO_INFO ){" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1194 = " += 1;" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_1195 = " += (countEach_";
  protected final String TEXT_1196 = " < 0 ? 0 : countEach_";
  protected final String TEXT_1197 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_1198 = NL + "\t\t\t\t\tinsertedCount_";
  protected final String TEXT_1199 = " += countSum_";
  protected final String TEXT_1200 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_1201 = NL + "\t\t\t\t\tupdatedCount_";
  protected final String TEXT_1202 = " += countSum_";
  protected final String TEXT_1203 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_1204 = NL + "\t\t\t\t\tdeletedCount_";
  protected final String TEXT_1205 = " += countSum_";
  protected final String TEXT_1206 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_1207 = NL + "\t\t\t\t}" + NL + "                }";
  protected final String TEXT_1208 = NL + "                \t";
  protected final String TEXT_1209 = NL + "                \tconn_";
  protected final String TEXT_1210 = ".commit();" + NL + "                \t";
  protected final String TEXT_1211 = NL + "                \tcommitCounter_";
  protected final String TEXT_1212 = "=0;" + NL + "                }";
