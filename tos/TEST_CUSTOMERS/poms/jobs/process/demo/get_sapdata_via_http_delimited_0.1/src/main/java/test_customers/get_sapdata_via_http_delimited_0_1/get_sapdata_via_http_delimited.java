...
package test_customers.get_sapdata_via_http_delimited_0_1;
...
/**
 * Job: get_sapdata_via_http_delimited Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class get_sapdata_via_http_delimited implements TalendJob {
	...
	private final String jobName = "get_sapdata_via_http_delimited";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					get_sapdata_via_http_delimited.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(get_sapdata_via_http_delimited.this,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_CUSTOMERS_get_sapdata_via_http_delimited = new byte[0];
		static byte[] commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http_delimited = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http_delimited.length) {
					if (length < 1024
							&& commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http_delimited.length == 0) {
						commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http_delimited = new byte[1024];
					} else {
						commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http_delimited = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http_delimited,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_CUSTOMERS_get_sapdata_via_http_delimited) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tNormalize_1 = 0; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1; i_tNormalize_1++) {
					...
					row3 = new row3Struct();
					String field_tExtractDelimitedFields_1 = row2.ResponseContent;
					...
					if (field_tExtractDelimitedFields_1 != null) {// C_01
						try {
							...
							row3.SAP_Client_MANDT = 0 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[0];
							row3.Customer_KUNNR = 1 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[1];
							row3.Country_Customer_LAND1 = 2 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[2];
							row3.Country_Name_NAME1 = 3 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[3];
							row3.City_Customer_ORT01 = 4 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[4];
							row3.Region_Customer_REGIO = 5 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[5];
							row3.Account_Group_Customer_KTOKD = 6 >= length_tExtractDelimitedFields_1 ? ""
									: newFields_tExtractDelimitedFields_1[6];
						...
						if (row3 != null) {
							...
							if (row3.SAP_Client_MANDT == null) {
								pstmt_tDBOutput_1.setNull(1,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(1,
										row3.SAP_Client_MANDT);
							}

							if (row3.Customer_KUNNR == null) {
							...
							if (row3.Country_Customer_LAND1 == null) {
								pstmt_tDBOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3,
										row3.Country_Customer_LAND1);
							}

							if (row3.Country_Name_NAME1 == null) {
								pstmt_tDBOutput_1.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4,
										row3.Country_Name_NAME1);
							}

							if (row3.City_Customer_ORT01 == null) {
								pstmt_tDBOutput_1.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5,
										row3.City_Customer_ORT01);
							}

							if (row3.Region_Customer_REGIO == null) {
								pstmt_tDBOutput_1.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6,
										row3.Region_Customer_REGIO);
							}

							if (row3.Account_Group_Customer_KTOKD == null) {
								pstmt_tDBOutput_1.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7,
										row3.Account_Group_Customer_KTOKD);
							}
	...
	public static void main(String[] args) {
		final get_sapdata_via_http_delimited get_sapdata_via_http_delimitedClass = new get_sapdata_via_http_delimited();

		int exitCode = get_sapdata_via_http_delimitedClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = get_sapdata_via_http_delimited.class
					.getClassLoader().getResourceAsStream(
							"test_customers/get_sapdata_via_http_delimited_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = get_sapdata_via_http_delimited.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : get_sapdata_via_http_delimited");
		}
...
/************************************************************************************************
 * 64852 characters generated by Talend Open Studio for Data Integration on the
 * April 26, 2019 3:15:35 PM CEST
 ************************************************************************************************/
