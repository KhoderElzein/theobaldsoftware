...
package test_customers.orchestrate_run_xu_command_0_1;
...
/**
 * Job: orchestrate_run_xu_command Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class orchestrate_run_xu_command implements TalendJob {
	...
	private final String jobName = "orchestrate_run_xu_command";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					orchestrate_run_xu_command.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(orchestrate_run_xu_command.this,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_CUSTOMERS_orchestrate_run_xu_command = new byte[0];
		static byte[] commonByteArray_TEST_CUSTOMERS_orchestrate_run_xu_command = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_CUSTOMERS_orchestrate_run_xu_command.length) {
					if (length < 1024
							&& commonByteArray_TEST_CUSTOMERS_orchestrate_run_xu_command.length == 0) {
						commonByteArray_TEST_CUSTOMERS_orchestrate_run_xu_command = new byte[1024];
					} else {
						commonByteArray_TEST_CUSTOMERS_orchestrate_run_xu_command = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TEST_CUSTOMERS_orchestrate_run_xu_command,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_CUSTOMERS_orchestrate_run_xu_command) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFixedFlowInput_2 = 0; i_tFixedFlowInput_2 < 1; i_tFixedFlowInput_2++) {
					...
					if (row2.EXIT_VALUE != null) { //
						row_tLogRow_4[0] = String.valueOf(row2.EXIT_VALUE);

					} //

					if (row2.ERROROUTPUT != null) { //
						row_tLogRow_4[1] = String.valueOf(row2.ERROROUTPUT);

					} //

					if (row2.ERROR_MESSAGE != null) { //
						row_tLogRow_4[2] = String.valueOf(row2.ERROR_MESSAGE);
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				test_customers.get_sapdata_from_mssqldb_0_1.get_sapdata_from_mssqldb childJob_tRunJob_1 = new test_customers.get_sapdata_from_mssqldb_0_1.get_sapdata_from_mssqldb();
				// pass DataSources
	...
	public static void main(String[] args) {
		final orchestrate_run_xu_command orchestrate_run_xu_commandClass = new orchestrate_run_xu_command();

		int exitCode = orchestrate_run_xu_commandClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = orchestrate_run_xu_command.class
					.getClassLoader().getResourceAsStream(
							"test_customers/orchestrate_run_xu_command_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = orchestrate_run_xu_command.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : orchestrate_run_xu_command");
		}
...
/************************************************************************************************
 * 79290 characters generated by Talend Open Studio for Data Integration on the
 * April 26, 2019 4:04:37 PM CEST
 ************************************************************************************************/
