...
package test_customers.run_xu_command_0_1;
...
/**
 * Job: run_xu_command Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class run_xu_command implements TalendJob {
	...
	private final String jobName = "run_xu_command";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					run_xu_command.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(run_xu_command.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_CUSTOMERS_run_xu_command = new byte[0];
		static byte[] commonByteArray_TEST_CUSTOMERS_run_xu_command = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_CUSTOMERS_run_xu_command.length) {
					if (length < 1024
							&& commonByteArray_TEST_CUSTOMERS_run_xu_command.length == 0) {
						commonByteArray_TEST_CUSTOMERS_run_xu_command = new byte[1024];
					} else {
						commonByteArray_TEST_CUSTOMERS_run_xu_command = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_CUSTOMERS_run_xu_command, 0,
						length);
				strReturn = new String(
						commonByteArray_TEST_CUSTOMERS_run_xu_command, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_CUSTOMERS_run_xu_command) {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				test_customers.get_sapcustomers_from_db_0_1.get_sapcustomers_from_db childJob_tRunJob_1 = new test_customers.get_sapcustomers_from_db_0_1.get_sapcustomers_from_db();
				// pass DataSources
	...
	public static void main(String[] args) {
		final run_xu_command run_xu_commandClass = new run_xu_command();

		int exitCode = run_xu_commandClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = run_xu_command.class
					.getClassLoader().getResourceAsStream(
							"test_customers/run_xu_command_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = run_xu_command.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : run_xu_command");
		}
...
/************************************************************************************************
 * 53089 characters generated by Talend Open Studio for Data Integration on the
 * March 29, 2019 11:27:34 AM CET
 ************************************************************************************************/
