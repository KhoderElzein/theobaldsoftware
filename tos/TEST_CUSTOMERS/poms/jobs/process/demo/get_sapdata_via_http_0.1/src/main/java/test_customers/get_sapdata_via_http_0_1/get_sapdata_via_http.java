...
package test_customers.get_sapdata_via_http_0_1;
...
/**
 * Job: get_sapdata_via_http Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class get_sapdata_via_http implements TalendJob {
	...
	private final String jobName = "get_sapdata_via_http";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					get_sapdata_via_http.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(get_sapdata_via_http.this, new Object[] {
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_CUSTOMERS_get_sapdata_via_http = new byte[0];
		static byte[] commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http.length) {
					if (length < 1024
							&& commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http.length == 0) {
						commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http = new byte[1024];
					} else {
						commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TEST_CUSTOMERS_get_sapdata_via_http, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_CUSTOMERS_get_sapdata_via_http) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "customers";
				} else {
	...
	public static void main(String[] args) {
		final get_sapdata_via_http get_sapdata_via_httpClass = new get_sapdata_via_http();

		int exitCode = get_sapdata_via_httpClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = get_sapdata_via_http.class
					.getClassLoader().getResourceAsStream(
							"test_customers/get_sapdata_via_http_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = get_sapdata_via_http.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : get_sapdata_via_http");
		}
...
/************************************************************************************************
 * 64440 characters generated by Talend Open Studio for Data Integration on the
 * April 26, 2019 5:19:58 PM CEST
 ************************************************************************************************/
