...
package test_customers.read_customer_from_csv_0_1;
...
/**
 * Job: read_customer_from_csv Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class read_customer_from_csv implements TalendJob {
	...
	private final String jobName = "read_customer_from_csv";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					read_customer_from_csv.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(read_customer_from_csv.this, new Object[] {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_CUSTOMERS_read_customer_from_csv = new byte[0];
		static byte[] commonByteArray_TEST_CUSTOMERS_read_customer_from_csv = new byte[0];

		public Integer SAP_Client_MANDT;

		public Integer getSAP_Client_MANDT() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_CUSTOMERS_read_customer_from_csv.length) {
					if (length < 1024
							&& commonByteArray_TEST_CUSTOMERS_read_customer_from_csv.length == 0) {
						commonByteArray_TEST_CUSTOMERS_read_customer_from_csv = new byte[1024];
					} else {
						commonByteArray_TEST_CUSTOMERS_read_customer_from_csv = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TEST_CUSTOMERS_read_customer_from_csv,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_CUSTOMERS_read_customer_from_csv) {

				try {

					int length = 0;

					this.SAP_Client_MANDT = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.SAP_Client_MANDT, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("SAP_Client_MANDT=" + String.valueOf(SAP_Client_MANDT));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null
					...
					tableName_tDBOutput_1 = "sap_customers";
				} else {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1
					...
					stmtCreate_tDBOutput_1
							.execute("CREATE TABLE ["
									+ tableName_tDBOutput_1
									+ "]([SAP_Client_MANDT] INT ,[Customer_KUNNR] VARCHAR(10)  ,[Country_Customer_LAND1] VARCHAR(2)  ,[Country_Name_NAME1] VARCHAR(50)  ,[City_Customer_ORT01] VARCHAR(20)  ,[Region_Customer_REGIO] VARCHAR(6)  ,[Account_Group_Customer_KTOKD] VARCHAR(6)  )");
				}
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/Elzein/Documents/GitHub/theobaldsoftware/tos/customers.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Elzein/Documents/GitHub/theobaldsoftware/tos/customers.csv",
								"UTF-8", ";", "\n", false, 1, 0, -1, -1, false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_1 != null
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.SAP_Client_MANDT = ParserUtils
								...
								row1.SAP_Client_MANDT = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.Customer_KUNNR = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row1.Country_Customer_LAND1 = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.Country_Name_NAME1 = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.City_Customer_ORT01 = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.Region_Customer_REGIO = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.Account_Group_Customer_KTOKD = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
						...
						if (row1 != null) {
							...
							if (row1.SAP_Client_MANDT == null) {
								pstmt_tDBOutput_1.setNull(1,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1,
										row1.SAP_Client_MANDT);
							}

							if (row1.Customer_KUNNR == null) {
							...
							if (row1.Country_Customer_LAND1 == null) {
								pstmt_tDBOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3,
										row1.Country_Customer_LAND1);
							}

							if (row1.Country_Name_NAME1 == null) {
								pstmt_tDBOutput_1.setNull(4,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4,
										row1.Country_Name_NAME1);
							}

							if (row1.City_Customer_ORT01 == null) {
								pstmt_tDBOutput_1.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5,
										row1.City_Customer_ORT01);
							}

							if (row1.Region_Customer_REGIO == null) {
								pstmt_tDBOutput_1.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6,
										row1.Region_Customer_REGIO);
							}

							if (row1.Account_Group_Customer_KTOKD == null) {
								pstmt_tDBOutput_1.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7,
										row1.Account_Group_Customer_KTOKD);
							}
					...
					if (!((Object) ("C:/Users/Elzein/Documents/GitHub/theobaldsoftware/tos/customers.csv") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final read_customer_from_csv read_customer_from_csvClass = new read_customer_from_csv();

		int exitCode = read_customer_from_csvClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = read_customer_from_csv.class
					.getClassLoader().getResourceAsStream(
							"test_customers/read_customer_from_csv_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = read_customer_from_csv.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : read_customer_from_csv");
		}
...
/************************************************************************************************
 * 48690 characters generated by Talend Open Studio for Data Integration on the
 * March 28, 2019 6:41:09 PM CET
 ************************************************************************************************/
