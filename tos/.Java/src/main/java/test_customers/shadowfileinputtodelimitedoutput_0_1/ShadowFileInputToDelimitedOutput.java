...
package test_customers.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements
		...
		final static byte[] commonByteArrayLock_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_CUSTOMERS_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/Elzein/Documents/GitHub/theobaldsoftware/tos/TEST_CUSTOMERS/temp/preview/customers.csv"))
				...
				globalMap.put("tFileOutputDelimited_FILE_NAME",
						fileName_tFileOutputDelimited);
				String[] headColutFileOutputDelimited = new String[7];
				...
				try {
					...
					Object filename_tFileInputDelimited = "C:/Users/Elzein/Documents/GitHub/theobaldsoftware/tos/customers.csv";
					...
					while (fid_tFileInputDelimited != null
						...
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[7];
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class
					.getClassLoader().getResourceAsStream(
							"test_customers/shadowfileinputtodelimitedoutput_0_1/contexts/"
...
/************************************************************************************************
 * 43675 characters generated by Talend Open Studio for Data Integration on the
 * March 28, 2019 6:40:32 PM CET
 ************************************************************************************************/
